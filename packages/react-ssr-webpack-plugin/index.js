...
const warn = msg => console.error(chalk.red(`[react-ssr-webpack-plugin] ${msg}\n`))
const tip = msg => console.log(chalk.yellow(`[react-ssr-webpack-plugin] ${msg}\n`))
...
class WebpackSSRPlugin {
  ...
  apply(compiler) {
    ...
    compiler.plugin('emit', (compilation, cb) => {
      ...
      const filename = this.options.filename || 'react-ssr-bundle.json'
